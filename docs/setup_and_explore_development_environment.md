...
## Start the vehicleApp DevContainer
...
### Start and check the VehicleApp
...
Now press <kbd>F5</kbd> to start the vehicleApp and see the log output on the `DEBUG CONSOLE`
...
![](dassets/ci-workflow-success.png)
