...
![refernce Architecture](https://github.com/SoftwareDefinedVehicle/vehicle-app-python-template/tree/usr/mandeep/5571-documentation-improvment/docs/assets/publish_container.png)
